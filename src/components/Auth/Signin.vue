<template>
    <div class="row justify-content-center " style="margin-top: 10vh;" >
        <div class="bg-image" style="background-image: url('../../assets/sign in/backgroun.png');"></div>
            <div class="col-3 p-0 my-auto "  >
                <div class="flex-column  p-5  shadow ">
                    ...
                    <button type="submit" class="btn btn-primary pt-2 pb-2 pr-5 pl-5 btn-grad " >Sign in</button>
                    </div>
